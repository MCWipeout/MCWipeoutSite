<script lang="ts">
	...
	const finalists = PlayerData.filter((t: any) => t.finalist).sort((a: any, b: any) =>
		a.finalist.finalistTime.localeCompare(b.finalist.finalistTime)
	);
...
<svelte:head>
	<title>Season 2 - MCWipeout</title>
</svelte:head>
		...
		{#each finalists as team, i}
			<TeamCard
				...
				badges={[
					...
					team.finalist ? { name: `Played Finals: ${team.finalist.finalistDayPlayed}` } : undefined
				]}
